<div class="w-full">
    ...
    <form wire:submit="register" class="space-y-4">
        ...
        <p class="text-center text-xs text-gray-500">
            ...
            <a href="#" class="underline" style="color: #4f46e5 !important;">{{ __('Terms of Service') }}</a>
            {{ __('and') }}
            <a href="#" class="underline" style="color: #4f46e5 !important;">{{ __('Privacy Policy') }}</a>.
        </p>
