        ...
        <div class="fixed bottom-4 right-4 z-50 w-96 max-w-full {{ $isMinimized ? 'h-16' : 'h-[600px]' }} bg-white rounded-lg shadow-2xl flex flex-col transition-all duration-300">
            ...
            <div class="flex items-center justify-between p-4 bg-blue-600 text-white rounded-t-lg">
                <div class="flex items-center gap-2">
                    ...
                    <h3 class="font-semibold">{{ __('Chat Support') }}</h3>
                </div>
                <div class="flex items-center gap-2">
                    <button
            ...
            @if (!$isMinimized)
                ...
                @else
                    ...
                    <div class="flex-1 flex flex-col items-center justify-center p-8 text-center">
                        ...
                        <h4 class="text-lg font-semibold text-gray-900 mb-2">{{ __('Welcome to Chat Support') }}</h4>
                        <p class="text-sm text-gray-600 mb-6">{{ __("We're here to help! Start a conversation with our team.") }}</p>
                        <button
