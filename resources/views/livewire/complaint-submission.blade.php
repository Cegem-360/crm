    ...
    <div class="max-w-3xl mx-auto">
        @if($submitted)
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 text-center">
                ...
                <h2 class="text-3xl font-bold text-gray-900 dark:text-white mb-4">{{ __('Complaint Submitted Successfully!') }}</h2>
                <p class="text-lg text-gray-600 dark:text-gray-300 mb-6">
                    {{ __('Thank you for bringing this to our attention. Our team will review your complaint and get back to you as soon as possible.') }}
                </p>
        ...
        @else
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden">
                ...
                <div class="bg-gradient-to-r from-red-600 to-red-700 dark:from-red-700 dark:to-red-800 px-8 py-6">
                    <h1 class="text-3xl font-bold text-white">{{ __('Submit a Complaint') }}</h1>
                    <p class="mt-2 text-red-100">{{ __('We take your concerns seriously and will address them promptly.') }}</p>
                </div>
                ...
                <form wire:submit="submit" class="px-8 py-6 space-y-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                placeholder="{{ __('Please provide detailed information about your complaint...') }}"></textarea>
                            @error('description')
                                <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                            @enderror
                    ...
                    <div class="flex items-center justify-between pt-4 border-t border-gray-200 dark:border-gray-700">
                        ...
                        <button
                            ...
                            <span wire:loading.remove wire:target="submit">{{ __('Submit Complaint') }}</span>
            ...
            <div class="mt-6 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
                <div class="flex">
                    ...
                    <div class="ml-3">
                        <h3 class="text-sm font-medium text-blue-800 dark:text-blue-300">{{ __('What happens next?') }}</h3>
                        <div class="mt-2 text-sm text-blue-700 dark:text-blue-400">
                            <ul class="list-disc list-inside space-y-1">
                                <li>{{ __("You'll receive a confirmation email") }}</li>
                                <li>{{ __('Our team will review your complaint within 24 hours') }}</li>
                                <li>{{ __('An agent will be assigned to your case') }}</li>
                                <li>{{ __("You'll be contacted with an update or resolution") }}</li>
                            </ul>
                        </div>
                    </div>
                </div>
