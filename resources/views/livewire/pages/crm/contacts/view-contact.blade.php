<div>
    ...
    <div class="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div class="flex items-center gap-4">
            <a href="{{ route('dashboard.contacts', ['team' => $currentTeam]) }}" class="p-2 text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 transition" wire:navigate>
        ...
        <x-primary-button :href="route('dashboard.contacts.edit', ['team' => $currentTeam, 'contact' => $contact])" icon="edit">
            {{ __('Edit') }}
        </x-primary-button>
    </div>
