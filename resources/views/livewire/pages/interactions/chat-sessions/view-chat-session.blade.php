<div>
    ...
    <div class="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div class="flex items-center gap-4">
            <a href="{{ route('dashboard.chat-sessions') }}" class="p-2 text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 transition" wire:navigate>
        ...
        <a href="{{ route('dashboard.chat-sessions.edit', $chatSession) }}" wire:navigate
                ...
                <div>
                    ...
                    <dd class="mt-1 text-sm text-gray-900 dark:text-white">
                        @if($chatSession->customer)
                            <a href="{{ route('dashboard.customers.view', $chatSession->customer) }}" wire:navigate class="text-indigo-600 dark:text-indigo-400 hover:underline">
