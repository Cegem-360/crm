<div>
    ...
    <div class="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div class="flex items-center gap-4">
            <a href="{{ route('dashboard.discounts') }}" class="p-2 text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 transition" wire:navigate>
        ...
        <a href="{{ route('dashboard.discounts.edit', $discount) }}" wire:navigate
        ...
        <div class="p-6">
            <dl class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                ...
                <div>
                    ...
                    <dd class="mt-1 text-sm text-gray-900 dark:text-white">
                        @if($discount->customer)
                            <a href="{{ route('dashboard.customers.view', $discount->customer) }}" wire:navigate class="text-indigo-600 dark:text-indigo-400 hover:underline">
                ...
                <div>
                    ...
                    <dd class="mt-1 text-sm text-gray-900 dark:text-white">
                        @if($discount->product)
                            <a href="{{ route('dashboard.products.view', $discount->product) }}" wire:navigate class="text-indigo-600 dark:text-indigo-400 hover:underline">
