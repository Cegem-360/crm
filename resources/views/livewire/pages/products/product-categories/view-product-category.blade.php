<div>
    ...
    <div class="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div class="flex items-center gap-4">
            <a href="{{ route('dashboard.product-categories') }}" class="p-2 text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 transition" wire:navigate>
        ...
        <a href="{{ route('dashboard.product-categories.edit', $productCategory) }}" wire:navigate
                ...
                <div>
                    ...
                    <dd class="mt-1 text-sm text-gray-900 dark:text-white">
                        @if($productCategory->parent)
                            <a href="{{ route('dashboard.product-categories.view', $productCategory->parent) }}" wire:navigate class="text-indigo-600 dark:text-indigo-400 hover:underline">
        ...
        <div class="mt-6 bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
            ...
            <ul class="divide-y divide-gray-200 dark:divide-gray-700">
                @foreach($productCategory->children as $child)
                    <li>
                        <a href="{{ route('dashboard.product-categories.view', $child) }}" wire:navigate class="flex items-center justify-between px-6 py-4 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition">
        ...
        <div class="mt-6 bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
            ...
            <ul class="divide-y divide-gray-200 dark:divide-gray-700">
                @foreach($productCategory->products as $product)
                    <li>
                        <a href="{{ route('dashboard.products.view', $product) }}" wire:navigate class="flex items-center justify-between px-6 py-4 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition">
                            <div>
